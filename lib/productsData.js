...
const SURFACE_PUMPS = [
  ...
  },
  {
    ...
    coverImage: '/products/cover/metering-pump1.jpg',
...
const SUBMERSIBLE_PUMPS = [
  ...
  },
  {
    ...createProduct('pump-sub-4', 'Dewatering Pumps', 'pumps', 'dewatering-pumps',
      'Submersible dewatering pumps for mines pit dewatering, construction site and emergency drainage'),
    coverImage: '/products/cover/dewatering-pump1.jpg',
...
export const ALL_VALVES = [
  ...
  },
  {
    ...
    heroImage: '/products/hero/y-strainer-valve2.jpeg'
  }
];
